...
\begin{figure}[Function resampled using interpolation]{FIG:RESAMPLE}{Function resampled using interpolation}
  ...
  \subfigure[SBFIG:RESAMPLE1]{Original observation}{\image{7.5cm}{}{original-function}} \quad
  \subfigure[SBFIG:RESAMPLE2]{Observation resampled}{\image{7.5cm}{}{function-resampled}}
\end{figure}
