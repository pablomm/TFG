...
\begin{figure}[Example of linear interpolation]{FIG:LINEAR}{Example of linear interpolation}
  \subfigure[SBFIG:LINEAR1]{Linear interpolation}{\image{7.5cm}{}{linear-interpolation}} \quad
  \subfigure[SBFIG:LINEAR2]{Bilinear interpolation}{\image{7.5cm}{}{surface-bilinear}}
\end{figure}
