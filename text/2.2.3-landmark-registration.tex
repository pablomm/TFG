...
\begin{figure}[Shift registration of a dataset]{FIG:LANDMARK}{Shift registration of a dataset}
  \subfigure[SBFIG:LANDMARK1]{Unregistered dataset $x_i(t)$}{\includegraphics[width=7.5cm]{landmark-dataset}} \quad
  \subfigure[SBFIG:LANDMARK2]{Registered population $x^*_i(t)$}{\includegraphics[width=7.5cm]{landmark-registration}}
\end{figure}
