...
\begin{figure}[Shift registration of a dataset]{FIG:LANDMARK}{Shift registration of a dataset}
  \subfigure[SBFIG:LANDMARK1]{Unregistered dataset $x_i(t)$}{\image{7cm}{}{landmark-registered}} \quad
  \subfigure[SBFIG:LANDMARK2]{Registered population $x^*_i(t)$}{\image{7cm}{}{landmark-registration}}
\end{figure}
