...
\begin{figure}[Example of spline interpolation]{FIG:SPLINE}{Example of spline interpolation}
	\subfigure[SBFIG:SPLINE1]{Spline interpolation}{\image{7.5cm}{}{spline-interpolation}} \quad
	\subfigure[SBFIG:SPLINE2]{First derivatives}{\image{7.5cm}{}{spline-derivatives-interpolation}}
\end{figure}
...
\begin{figure}[Interpolation of surface]{FIG:BISPLINE}{Interpolation of surface with bicubic splines}
	\subfigure[SBFIG:BISPLINE1]{Surface interpolated}{\image{7.5cm}{}{surface-bicubic}} \quad
	\subfigure[SBFIG:BISPLINE2]{Partial derivative $\partial_x$}{\image{7.5cm}{}{surface-bicubic-dx}}
\end{figure}
