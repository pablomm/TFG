...
Introdicción a las sección de ejemplos.
...
\includepdf[pages=-, nup=2x2]{notebooks-pdf/Interpolation}\label{EX:INTERPOLATION}

%\section{Extrapolation\label{EX:EXTRAPOLATION}}

\includepdf[pages=-, nup=2x2]{notebooks-pdf/Extrapolation}\label{EX:EXTRAPOLATION}
