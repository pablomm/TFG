...
Let $(X, d)$ be a metric space and $\{x_i\}{ i=1}^{N}$ random points in $X$.
We will defined the Fréchet variance of a point $p \in X$ as
...
\begin{figure}[Karcher mean of bimodal dataset]{FIG:KARCHER}{Karcher mean of bimodal dataset}
  \subfigure[SBFIG:KARCHER1]{Dataset of bimodal samples}{\image{7cm}{}{0-empty}} \quad
  \subfigure[SBFIG:KARCHER2]{Usual mean and Karcher mean on $\mathscr{A}$}{\image{7cm}{}{0-empty}}
\end{figure}

To calculate this mean we will use the DPA algorithm explained in the appendix B.2.
...
Karcher mean. In the figure \ref{RANK} it is used this idea to rank a dataset of
...
as it is shown in the figure \ref{SBFIG:RANK2}.s

\begin{figure}[Dataset ranked by distance to the Karcher mean]{FIG:RANK}{Dataset ranked by distance to the Karcher mean}
  \subfigure[SBFIG:RANK1]{Elastic distance}{\image{7cm}{}{0-empty}} \quad
  \subfigure[SBFIG:RANK"]{Phase distance}{\image{7cm}{}{0-empty}}
\end{figure}
