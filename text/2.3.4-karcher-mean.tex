...
\begin{figure}[Karcher mean of bimodal dataset]{FIG:KARCHER}{Karcher mean of bimodal dataset}
  \subfigure[SBFIG:KARCHER1]{Dataset of unimoal samples}{\image{7cm}{}{0-empty}} \quad
  \subfigure[SBFIG:KARCHER2]{Usual mean and Karcher mean on $\mathscr{A}$}{\image{7cm}{}{0-empty}} \\
  \subfigure[SBFIG:RANK1]{Ranked by elastic distance}{\image{7cm}{}{0-empty}} \quad
  \subfigure[SBFIG:RANK2]{Ranked by phase distance}{\image{7cm}{}{0-empty}}
\end{figure}
