...
\begin{figure}[Pairwise alignment]{FIG:PAIRWISE}{Pairwise alignment}
  \subfigure[SBFIG:PAIRWISE1]{Alignment of $f_1$ to $f_2$}{\image{7cm}{}{pairwise-alignment}} \quad
  \subfigure[SBFIG:PAIRWISE2]{Warping built by the DPA algorithm}{\image{7cm}{}{pairwise-alignment-warping}}
\end{figure}
