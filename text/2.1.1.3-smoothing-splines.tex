...
\subfigure[SBFIG:SMOOTHING1]{Cubic smoothing}{\image{7cm}{}{smoothing-splines}} \quad
\subfigure[SBFIG:SMOOTHING2]{Several values of the smoothing factor}{\image{7cm}{}{smoothing-splines-values}}
\end{figure}
