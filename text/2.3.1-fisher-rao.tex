...
\begin{figure}[Tangent space]{FIG:TANGENT}{Tangent space}
  \includegraphics[width=7.5cm]{tangent-space}
\end{figure}
...
\begin{figure}[Geodesic path in $\mathcal{F}$]{FIG:GEODESIC}{Geodesic path in $\mathcal{F}$ and the corresponding SRSF's}
  \subfigure[SBFIG:GEODESIC1]{Some steps of the geodesic path between $f_1$ and $f_2$}{\includegraphics[width=7.5cm]{geodesic}} \quad
