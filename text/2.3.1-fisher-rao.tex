...
\begin{figure}[Geodesic path in $\mathcal{F}$]{FIG:GEODESIC}{Geodesic path in $\mathcal{F}$ and the corresponding SRSF's}
  \subfigure[SBFIG:GEODESIC1]{Some steps of the geodesic path between $f_1$ and $f_2$}{\image{7cm}{}{geodesic}} \quad
  \subfigure[SBFIG:GEODESIC2]{SRSF of the path}{\image{7cm}{}{srsf-geodesic}}
\end{figure}
...
\{FIG:GEODESIC} becomes in a straight line
between SRSFS, $\alpha(\tau) = (1 - \tau)q_1 + \tau q_2$ \, 0 \le \tau \le 1.
