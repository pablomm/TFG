...
\documentclass[epsbased,copyleft,loe,lof,final,extendedindex,firstnumbered,tfg,english]{tfgtfmthesisuam}
...
\levelin{Computer Science and Mathematics}
...
\dedication{ }
%\dedication{A Eloy y a Oscar."); INSERT INTO alumnos values ("Pablo", "Marcos");--}
\famouscite{The mathematician’s patterns, \\
			like the painter’s or the poet’s must be beautiful; \\ 
			the ideas like the colours or the words, \\
			must fit together in a harmonious way. \\[0.1em] \begin{flushright}G.H. Hardy, A Mathematician's Apology\end{flushright} }
...
\chapter{State of the art: interpolation, registration, and nearest neighbors\label{CAP:STATEOFART}}{text/2-state-of-the-art}
