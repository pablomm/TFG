...
\chapter{Introduction\label{CAP:INTRODUCTION}}{text/1-introduction.tex}
  \section{Motivation\label{SEC:MOTIVATION}}{text/1.1-motivation.tex}
  \section{Goals and scope\label{SEC:GOALS}}{text/1.2-goals.tex}
  \section{Document Structure\label{SEC:STRUCTURE}}{text/1.3-structure.tex}
