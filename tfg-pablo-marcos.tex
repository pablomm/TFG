...
\chapter{Design and development\label{SEC:DESIGNDEV}}{text/3-design-development}

\section{Analysis\label{SEC:ANALYSIS}}{text/3.1-analysis}
\section{Analysis\label{SEC:DESIGN}}{text/3.2-design}
  \subsection{Representation module\label{SEC:REPRMOD}}{text/3.2.1-representation}
  \subsection{Representation module\label{SEC:PREPMOD}}{text/3.2.2-preprocessing}
  \subsection{Representation module\label{SEC:MLMOD}}{text/3.2.3-ml}
  \subsection{Representation module\label{SEC:MISCMOD}}{text/3.2.4-misc}
  \subsection{Representation module\label{SEC:DATAMOD}}{text/3.2.5-dataset}
\section{Analysis\label{SEC:CODING}}{text/3.3-coding-docs-tests}
\section{Analysis\label{SEC:DEVELOPMENT}}{text/3.4-development-ci-cv}

\chapter{Conclusions and future work\label{SEC:CONCLUSIONS}}{text/4-conclusions}
