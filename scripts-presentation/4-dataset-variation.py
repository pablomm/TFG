...
if __name__ == "__main__":
    ...
    l1, *_ = plt.plot(t, data_phase, color='C0', label="$sin(t + c_i)$")
    l2, *_ = plt.plot(t, data_phase.mean(axis=1), color='red', linestyle='dashed',
             label='mean')
    plt.xlim(lims)
    #plt.yticks([])
    #plt.xticks([])
    ...
    l1, *_ = plt.plot(t, data_amp, color='C0', label="$c_i sin(t)$")
    l2, *_ = plt.plot(t, data_amp.mean(axis=1), color='red', linestyle='dashed',
             label='mean')
    plt.xlim(lims)
    #plt.yticks([])
    #plt.xticks([])
